 ...
 * @since       2.5
 */
class KnowTableKnow extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__know', 'id', $db);
	}
	...
	public function check()
	{
		...
		if (trim($this->name) == '')
		{
			$this->setError(JText::_('COM_KNOW_WARNING_PROVIDE_VALID_NAME'));
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('Know', 'KnowTable');
