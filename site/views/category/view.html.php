...
/**
 * HTML Category View class for the Know component
 *
 * @package     Know
 * @subpackage  com_know
 * @since       2.5
 */
class KnowViewCategory extends JViewLegacy
{
	protected $state;
	...
	protected function _prepareDocument()
	{
		...
		if ($menu && ($menu->query['option'] != 'com_know' || $menu->query['view'] == 'know' || $id != $this->category->id))
		{
